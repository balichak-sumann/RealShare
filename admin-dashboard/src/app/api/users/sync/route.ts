  ...
  try {
    ...
    const profile = await prisma.profile.upsert({
      ...
      update: {
        ...
        phone_number: body.phone_number || decodedToken.phone_number || existingProfile?.phone_number || null,
        full_name: body.full_name || decodedToken.name || decodedToken.email?.split('@')[0] || 'User',
      ...
      create: {
        id: decodedToken.uid,
        email: decodedToken.email || null,
        phone_number: body.phone_number || decodedToken.phone_number || null,
        full_name: body.full_name || decodedToken.name || decodedToken.email?.split('@')[0] || 'User',
        full_address: body.full_address || null,
        avatar_url: decodedToken.picture || null,
        role: requestedRole,
