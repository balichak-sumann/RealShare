...
export default function FeaturedPropertiesPage() {
    ...
    const fetchProperties = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const allProps = Array.isArray(data) ? data : [];
          setProperties(allProps.filter(p => p.featured === true));
        }
      } catch (err) {
  ...
  return (
    <AdminLayout title="Featured Properties Management">
      {/* Toast */}
      {toastMessage && (
        <div
          style={{
            ...
            <form onSubmit={handleCreateProperty} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
              ...
              <div style={{ background: "#F8FAFC", padding: "16px", borderRadius: "12px", border: "1px solid #E2E8F0" }}>
                ...
                {(newProp.type === "Commercial" || newProp.type === "Fractional") && (
                  <>
                    <div className="rs-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "12px" }}>
                      <div>
                        <label style={{ fontSize: "0.75rem", fontWeight: 600, color: "#475569" }}>Floor Type</label>
                        <select value={newProp.floorType} onChange={(e) => setNewProp({ ...newProp, floorType: e.target.value })}
                          style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #CBD5E1", marginTop: "4px", background: "#fff", fontSize: "0.85rem" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "24px" }}>
              ...
              <div className="rs-grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "10px", marginBottom: "18px" }}>
