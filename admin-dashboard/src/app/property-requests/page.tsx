...
export default function PropertyRequestsPage() {
  ...
  return (
    <AdminLayout title="Property Requests">
      ...
      {/* Details Modal */}
      {selectedInquiry && (
        <div className="rs-modal-overlay" style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
