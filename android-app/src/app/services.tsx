...
export default function ServicesScreen() {
  ...
  const openInquiry = (serviceTitle: string) => {
    if (serviceTitle.includes('Home Loans')) router.push('/services/home-loans');
    else if (serviceTitle.includes('Interior Design')) router.push('/services/interior-design');
    else if (serviceTitle.includes('Property Management')) router.push('/services/property-management');
    else {
