    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/services`, {
        ...
        body: JSON.stringify({
          ...
          notes: propertyType.trim() ? `Property Type: ${propertyType.trim()}` : undefined,
        }),
      });
      if (!res.ok) {
      ...
      Alert.alert('Request Received 🎉', `Thank you! Our interior design team will reach out to you shortly.`);
      setPropertyType('');
    } catch (e) {
    ...
    <View style={styles.container}>
      {!isDesktop && (
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Interior Design</Text>
          <View style={{ width: 24 }} />
        </View>
      )}
      ...
      <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={false}>
        <ImageBackground source={HERO_IMAGE} style={[styles.heroBanner, isDesktop && styles.heroBannerDesktop]}>
          ...
          <View style={styles.heroContent}>
            ...
            <Text style={styles.heroTitle}>Transform your space into a <Text style={{ color: GoldSystem.primaryGold }}>masterpiece.</Text></Text>
            <Text style={styles.heroDesc}>Premium design consultations and end-to-end execution for your dream home.</Text>
          </View>
        </ImageBackground>
        ...
        <View style={[styles.mainSection, isDesktop && styles.mainSectionDesktop]}>
          <View style={[styles.detailsContainer, isDesktop && { flex: 1 }]}>
            ...
            <View style={styles.featureItem}>
              ...
              <View style={styles.featureTextContainer}>
                <Text style={styles.featureTitle}>Experienced & verified designers</Text>
                <Text style={styles.featureDesc}>Work with vetted professionals who bring years of expertise to your project.</Text>
              </View>
            </View>
            ...
            <View style={styles.featureItem}>
              ...
              <View style={styles.featureTextContainer}>
                <Text style={styles.featureTitle}>Compare quotes and pay right price</Text>
                <Text style={styles.featureDesc}>Get multiple estimates to ensure you always get the best deal for your budget.</Text>
              </View>
            </View>
            ...
            <View style={styles.featureItem}>
              <View style={styles.featureIcon}><Text style={styles.iconText}>🎁</Text></View>
              <View style={styles.featureTextContainer}>
                <Text style={styles.featureTitle}>Special offers & discounts</Text>
                <Text style={styles.featureDesc}>Enjoy exclusive RealShare discounts on premium interior packages.</Text>
              </View>
            </View>
            ...
            <View style={styles.featureItem}>
              <View style={styles.featureIcon}><Text style={styles.iconText}>🏆</Text></View>
              <View style={styles.featureTextContainer}>
                <Text style={styles.featureTitle}>Our TOP designers</Text>
                <Text style={styles.featureDesc}>Collaborate with award-winning studios for your dream home.</Text>
              </View>
            </View>
          ...
          <View style={[styles.formContainer, isDesktop && { width: 400 }]}>
            ...
            <TextInput
              style={styles.input}
              placeholder="Property Type (e.g., 3BHK Apartment, Villa)"
              value={propertyType}
